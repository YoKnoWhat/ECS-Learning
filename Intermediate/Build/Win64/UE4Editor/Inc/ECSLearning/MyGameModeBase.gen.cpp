...
#include "ECSLearning/MyGameModeBase.h"
#ifdef _MSC_VER
#pragma warning (push)
...
// Cross Module References
	ECSLEARNING_API UClass* Z_Construct_UClass_AMyGameModeBase_NoRegister();
	ECSLEARNING_API UClass* Z_Construct_UClass_AMyGameModeBase();
	ENGINE_API UClass* Z_Construct_UClass_AGameModeBase();
	UPackage* Z_Construct_UPackage__Script_ECSLearning();
// End Cross Module References
	...
	UObject* (*const Z_Construct_UClass_AMyGameModeBase_Statics::DependentSingletons[])() = {
		...
		(UObject* (*)())Z_Construct_UPackage__Script_ECSLearning,
	};
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_AMyGameModeBase_Statics::ClassParams = {
		...
		nullptr, 0,
		METADATA_PARAMS(Z_Construct_UClass_AMyGameModeBase_Statics::Class_MetaDataParams, ARRAY_COUNT(Z_Construct_UClass_AMyGameModeBase_Statics::Class_MetaDataParams))
	};
	...
	IMPLEMENT_CLASS(AMyGameModeBase, 1438117156);
	static FCompiledInDefer Z_CompiledInDefer_UClass_AMyGameModeBase(Z_Construct_UClass_AMyGameModeBase, &AMyGameModeBase::StaticClass, TEXT("/Script/ECSLearning"), TEXT("AMyGameModeBase"), false, nullptr, nullptr, nullptr);
